...
if not admin_id:
    ...
    cursor.execute(
        "INSERT INTO accounts (username, name, email, password, created_at, role_id) VALUES (%s, %s, %s, %s, %s) RETURNING id",
        ('admin', 'admin', NPMINE_WEB_APP_EMAIL, admin_password_hash, datetime.utcnow(), admin_role_id)
    )
